...
ACTION_PLANS = {
    ...
    'Mixed-Signal Market': {
        ...
        'risk':      'Unclear ROI, budget dilution across segments',
    },
}
...
# ══════════════════════════════════════════════════════════════════
    ...
    if st.button("🤖  Run ML Priority Prediction", use_container_width=True):
        ...
        with r3:
            ...
            RECS={'High':("Aggressive Offensive Strategy","All key signals are strong — maximize ROI now.","Increase Budget","#eef2ff"),
...
# ══════════════════════════════════════════════════════════════════
    ...
    st.markdown("""<div class="proxy-note" style="margin-top:16px;"><b>Revenue Proxy Note:</b> Revenue Opportunity Level and Market Value Proxy are directional business proxies, not causal ROI forecasts. They combine ML priority, visitor scale, average spending, momentum, SNS attention, and Korean Wave signals to support relative market comparison.</div>""",unsafe_allow_html=True)
