...
def load_model():
    ...
    feat_imp = pd.read_csv('model/feature_importance.csv')
    return model, le, feature_cols, feat_imp

@st.cache_data
def load_data():
    df = pd.read_csv('full_dataset.csv', encoding='utf-8-sig')
    sat = pd.read_csv('satisfaction_data.csv', encoding='utf-8-sig')
    hallyu = pd.read_csv('hallyu_spending.csv', encoding='utf-8-sig')
    hallyu_ind = pd.read_csv('hallyu_industry.csv', encoding='utf-8-sig')
