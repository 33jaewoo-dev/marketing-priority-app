...
with st.sidebar:
    ...
    <div style="padding: 8px 0 24px 0;">
        <div style="font-family:'Syne',sans-serif; font-size:18px; font-weight:800;
                    color:#e8eaf0; letter-spacing:-0.02em; line-height:1.2;">
            Inbound Marketing<br/>
            <span style="color:#3d6fff;">Intelligence</span>
        </div>
        <div style="font-size:11px; color:#5a6280; margin-top:6px; letter-spacing:0.08em; text-transform:uppercase;">
...
if page == "📊  Overview":
    ...
    CHART_TEMPLATE = dict(
        ...
        xaxis=dict(gridcolor='#1e2640', linecolor='#252d45'),
        yaxis=dict(gridcolor='#1e2640', linecolor='#252d45'),
    )
    ...
    with col4:
        ...
        fig4 = px.bar(feat_disp, x='importance', y='feature', orientation='h',
                      color='importance', color_continuous_scale=['#1a2035','#3d6fff','#88aaff'])
        fig4.update_layout(height=280, yaxis={'categoryorder':'total ascending'},
                           showlegend=False, coloraxis_showscale=False, **CHART_TEMPLATE)
    ...
    for col, label, value, sub in [
        ...
        with col:
            ...
            <div class="metric-card">
                ...
                <div style="font-family:'Syne',sans-serif; font-size:20px;
                            font-weight:700; color:#e8eaf0;">{value}</div>
                <div style="font-size:12px; color:#5a6280; margin-top:4px;">{sub}</div>
            </div>
            """, unsafe_allow_html=True)
